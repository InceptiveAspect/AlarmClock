...
import com.ias.alarm.persistance.AlarmDatabaseHelper;
...
public class BaseTest {
    ...
    protected void assertTimerView(String s) {
        onView(withId(com.ias.alarm.R.id.hours_tens)).check(matches(withText("" + s.charAt(0))));
        onView(withId(com.ias.alarm.R.id.hours_ones)).check(matches(withText("" + s.charAt(1))));
        onView(withId(com.ias.alarm.R.id.minutes_tens)).check(matches(withText("" + s.charAt(3))));
        onView(withId(com.ias.alarm.R.id.minutes_ones)).check(matches(withText("" + s.charAt(4))));
    }
